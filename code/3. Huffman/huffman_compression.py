...
def save_compressed_data_to_file(encoded_data, filename):
    ...
    print(f"压缩数据已保存到文件: refs/{filename}")
...
def save_huffman_codebook(codebook, filename):
    ...
    print(f"Huffman编码字典已保存到文件: refs/{filename}")
...
def save_compressed_data_to_binary_file(encoded_data, filename):
    ...
    print(f"压缩数据（以二进制格式）已保存到文件: refs/{filename}")
...
# Huffman编码
huffman_encoded_data, huffman_codebook = huffman_encode(signal_data)
print("Huffman编码结果:", huffman_encoded_data)

# 保存数据到文件
# save_compressed_data_to_file(huffman_encoded_data, 'compressed_data_huffman.txt')
